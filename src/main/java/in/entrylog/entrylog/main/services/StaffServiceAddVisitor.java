 ...
 */
public class StaffServiceAddVisitor extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        ConnectingTask.StaffFetchingAddVisitor staffFetching = task.new StaffFetchingAddVisitor(OrganizationID, detailsValue, staffset);
